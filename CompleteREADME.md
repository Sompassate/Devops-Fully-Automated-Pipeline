...
1) ###### GitHub setup
    Fork GitHub Repository by using the existing repo "Devops-Fully-Automated-Pipeline" (https://github.com/Sompassate/Devops-Fully-Automated-Pipeline.git)     
    - Go to GitHub (github.com)
    - Login to your GitHub Account
    - **Fork repository "devops-fully-automated" (https://github.com/Sompassate/Devops-Fully-Automated-Pipeline.git) & name it "Devops-Fully-Automated-Pipeline"**
...
2) ###### Jenkins/Maven/Ansible
    ...
    - User data (Copy the following user data): https://github.com/Sompassate/Devops-Fully-Automated-Pipeline.git/jenkins-maven-ansible-setup.sh
    - Launch Instance
...
3) ###### SonarQube
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/Sompassate/Devops-Fully-Automated-Pipeline.git/blob/installations/sonarqube-setup.sh
    - Launch Instance
...
4) ###### Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/Sompassate/Devops-Fully-Automated-Pipeline.git/blob/installations/nexus-setup.sh
    - Launch Instance
...
5) ###### EC2 (Dev/Stage/Prod)
    ...
    - Security Group (Open): 8080, 9100 and 22 to 0.0.0.0/0
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/Sompassate/Devops-Fully-Automated-Pipeline.git/blob/installations/deployment-servers-setup.sh
    - Launch Instance
...
6) ###### Prometheus
    ...
    - User data (Copy the following user data): https://github.com/Sompassate/Devops-Fully-Automated-Pipeline.git/blob/installations/prometheus-setup.sh
    - Launch Instance
...
7) ###### Grafana
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/Sompassate/Devops-Fully-Automated-Pipeline.git/blob/installations/grafana-setup.sh
    - Launch Instance
...
4)  #### Global tools configuration:
    - Click on Manage Jenkins --> Global Tool Configuration
        ...
        **Note:** By default the **Install Oracle Java SE Development Kit from the website** make sure to close that option by clicking on the image as shown below.
        ...
        ![JDKSetup!](https://github.com/Sompassate/Devops-Fully-Automated-Pipeline.git/blob/main/jdk_setup.png)
...
1) #### SonarQube IP change
    - Go back to your local, open your "Devops-Fully-Automated-Pipeline" project on VSCODE
